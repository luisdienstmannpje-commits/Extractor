...
class LegalRuleEngine:
    ...
    def _dict_para_contexto(self, dados: dict) -> ContextoJuridico:
        ...
        campos_escalares = {"numero_processo", "reclamante", "reclamada", "motivo_rescisao", "tipo_contrato", "data_admissao", "data_demissao", "data_saida_ctps", "data_ajuizamento", "data_sentenca", "salario_base", "jornada_contratual", "aviso_previo_dias", "indice_correcao", "juros_mora", "fgts_sobre_aviso_previo", "fgts_multa_40_aviso_previo", "fgts_sobre_ferias_indenizadas", "fgts_periodo_completo", "percentual_honorarios", "honorarios_sucumbenciais", "justica_gratuita"}
