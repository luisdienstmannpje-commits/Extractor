...
class LabRegra20260313030848Rule(LegalRule):
    """
    Deferido: férias proporcionais + 1/3

    Correção identificada pela perita:
    Incluir férias proporcionais + 1/3 no cálculo conforme determinado na sentença
    """
    ...
    prioridade = 40
    descricao = "Deferido: férias proporcionais + 1/3"
