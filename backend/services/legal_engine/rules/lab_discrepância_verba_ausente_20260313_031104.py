...
Gerado em:   2026-03-13T03:08:48.444011
...
class LabRegra20260313030848Rule(LegalRule):
    """
    Deferido: adicional noturno

    Correção identificada pela perita:
    Incluir verba conforme sentença. Trecho da manifestação: a)  ADICIONAL NOTURNO
    """
    ...
    prioridade = 40
    descricao = "Deferido: adicional noturno"
