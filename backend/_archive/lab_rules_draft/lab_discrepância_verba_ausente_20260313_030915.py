...
class LabRegra20260313030848Rule(LegalRule):
    """
    Deferido: 13º salário proporcional

    Correção identificada pela perita:
    Incluir 13º salário proporcional no cálculo conforme determinado na sentença
    """
    ...
    prioridade = 40
    descricao = "Deferido: 13º salário proporcional"
