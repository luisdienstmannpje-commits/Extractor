...
- `advogado_reclamada`: nome do advogado da reclamada (empresa). Em 2º grau a empresa pode aparecer como RECORRENTE ou RECORRIDO — extrair advogados listados imediatamente abaixo do nome da empresa (ex.: KONA TRANSPORTES, PLATLOG), ignorando rótulos de polo. Âncoras: "Advogado(a): [Nome]" após o nome da empresa; rodapé da primeira página; Partes (RECORRENTE/RECORRIDO/ADVOGADO) no cabeçalho PJe.
- `juiz_responsavel`: nome do juiz que assinou a sentença — buscar na assinatura digital ao final
- `valor_causa`: localizar no início do documento (cabeçalho PJe), em geral logo abaixo do número do processo. Âncoras: "Valor da causa: R$ X.XXX,XX", "Valor atribuído à causa", "Dá-se à causa o valor de R$ ...". Retornar valor numérico (ex: R$ 32.181,17).
- `data_ajuizamento`: no cabeçalho PJe, extrair "Data da Autuação" como data de ajuizamento (DD/MM/AAAA). O bloco com "Data da Autuação:", "Valor da causa:" e "Partes:" deve ser preservado na string de extração.
- `justica_gratuita`: procurar no final da fundamentação ou no dispositivo. Âncoras: "concedo/defiro os benefícios da justiça gratuita", "gratuidade judiciária", "Defiro a gratuidade judiciária", "Justiça Gratuita", "Isenção de Custas". Em Acórdãos, verificar se o benefício foi mantido da origem. Retornar true (Sim) se concedida/deferida/mantida, false (Não) se não mencionado ou indeferido.
