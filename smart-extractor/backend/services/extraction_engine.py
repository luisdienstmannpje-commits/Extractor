...
# Bloco 1 — Identificação e Juízo: ordem EXATA para PJe-Calc e capa do processo
ESTRUTURAL_KEYS = [
    "numero_processo", "vara_trabalho", "juiz_responsavel", "data_sentenca", "data_ajuizamento",
    "valor_causa", "reclamante", "reclamada", "advogado_reclamante", "advogado_reclamada",
    "tipo_rito", "justica_gratuita",
    "prescricao_quinquenal",  # Bloco 1 — data-limite prescrição (ajuiz. - 5 anos)
]
CONTRATUAL_KEYS = [
